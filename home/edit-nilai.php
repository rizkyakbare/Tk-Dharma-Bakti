...
include "../koneksi.php";
if(isset($_GET['id'])){
  $tampiltgs = mysqli_query($conf, "SELECT * FROM kriteria_nilai_harian WHERE id_kriteria_harian = '$_GET[id]'");
...
<!DOCTYPE html>
<html>
<title>TK Dharma Bakti-Edit Nilai</title>
...
<div class="container">
  ...
  <form action="edit-fungsinilai.php" method="POST" class="needs-validation" novalidate>
    <p></p>
    <div class="form-group">
      <label for="id_rapor">ID Nilai Harian :</label>
    ...
    <p></p>
        <p></p>
    <div class="form-group">
      <label for="noinduk_siswa">Nama :</label>
    ...
    <p></p>
        <p></p>
    <div class="form-group">
      <label for="cat_rapor">Nilai :</label>
    ...
    <input type="hidden" name="id_kriteria_harian" value="<?php echo $raport['id_kriteria_harian']; ?>">
    <p></p>
