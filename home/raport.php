...
include "../koneksi.php";
session_start();
$tampil = mysqli_query($conf, "SELECT * FROM raport");
?>
<!DOCTYPE html>
<html>
...
<div class="container">
<h2>Raport Siswa</h2>  
<a href="raportdata.php"><p><p><button type="button" class="btn btn-primary btn-sm">Isi Data Raport</button></p></p></a>    
    ...
    <tbody>
        ...
        while($r=mysqli_fetch_array($tampil)){
            echo "<tr>
                        ...
                        <td>$r[nilai_huruf]</td>
                        <td>
                        <a href='edit-raport.php?id=$r[id_rapor]'><button type='button' class='btn btn-success btn-sm'>Edit</button></a>
                        <a href='delete-raport.php?id=$r[id_rapor]'><button type='button' class='btn btn-danger btn-sm'>Hapus</button></a>
                        </td>
                </tr>";
        $no++;
        }
